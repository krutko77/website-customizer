 ...
 *      баннер показывается заново. Это РЕКОМЕНДУЕМАЯ ПРАКТИКА, а не
 *      требование закона: 152-ФЗ (п. 8 ч. 4 ст. 9) требует лишь указать в
 *      согласии работающий способ отзыва — у сайта это почта оператора,
 *      описанная в Политике. Принцип «отзыв не сложнее, чем дача» — норма
 *      GDPR (ст. 7 п. 3), на этот сайт не распространяется. Подробнее — в
 *      README.md, раздел «Правовой статус».
