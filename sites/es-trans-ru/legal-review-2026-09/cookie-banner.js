...
(function () {
	...
	var TRANSLATIONS = {
		...
		// сайта внутри app.min.js, иначе при переключении языка je() вернёт
		// старый текст — см. README, «Две копии словаря».
		'cookie-banner-7': { ru: 'Согласен', en: 'I agree', cn: '我同意' },
		// Ссылка на Политику cookie. Ключа cookie-banner-8 в словаре сайта нет —
		// добавляется тем же патчем app.min.js.
		'cookie-banner-8': {
			ru: 'Политикой использования файлов cookie',
